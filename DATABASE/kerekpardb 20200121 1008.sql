...
-- Script date 2020. 01. 21. 10:08:31
...
CREATE TABLE kerekpar (
  id INT(11) NOT NULL AUTO_INCREMENT,
  cikk_szam CHAR(16) DEFAULT NULL,
  marka_id INT(11) DEFAULT NULL,
  vazmeret_id INT(11) DEFAULT NULL,
  felni_atmero_id INT(11) DEFAULT NULL,
  valto_tipus INT(11) DEFAULT NULL,
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE BicycleUpdate(IN paramId INT, IN paramCikk_szam CHAR(16), IN paramMarka_id INT, IN paramVazmeret_id INT, IN paramFelni_atmero_id INT, IN paramValto_tipus INT, IN paramTipus_id INT, IN paramAr INT)
BEGIN
UPDATE kerekpar
SET kerekpar.cikk_szam = paramCikk_szam,
    kerekpar.marka_id = paramMarka_id,
    kerekpar.vazmeret_id = paramVazmeret_id,
    kerekpar.felni_atmero_id = paramFelni_atmero_id,
    kerekpar.valto_tipus = paramValto_tipus,
    kerekpar.tipus_id = paramTipus_id,
    kerekpar.ar = paramAr
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE BicycleSelectByItemNumber(IN paramCikk_szam CHAR(16))
BEGIN
SELECT
  *
FROM kerekpar
WHERE cikk_szam = paramCikk_szam;
END
$$
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE BicycleCreate(IN paramId INT, IN paramCikk_szam CHAR(16), IN paramMarka_id INT, IN paramVazmeret_id INT, IN paramFelni_atmero_id INT, IN paramValto_tipus INT, IN paramTipus_id INT, IN paramAr INT)
BEGIN
INSERT INTO kerekpar (id, cikk_szam, marka_id, vazmeret_id, felni_atmero_id, valto_tipus, tipus_id, ar)
  VALUES (paramId, paramCikk_szam, paramMarka_id, paramVazmeret_id, paramFelni_atmero_id, paramValto_tipus, paramTipus_id, paramAr);
END
$$
...
CREATE TABLE vasarlas (
  id INT(11) NOT NULL AUTO_INCREMENT,
  vasarlo_uniq_id VARCHAR(255) DEFAULT NULL,
...
SELECT
  ...
  user.role
FROM user
WHERE user.uniq_id = paramUniqID;
END
$$
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE UserDelete(IN paramUniq_id VARCHAR(255))
BEGIN
DELETE
  FROM user
WHERE user.uniq_id = paramUniq_id;
END
$$
...
BEGIN
INSERT INTO user (uniq_id, nev, email, jelszo, role)
