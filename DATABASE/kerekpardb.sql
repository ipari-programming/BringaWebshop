...
-- Script date 2020. 01. 21. 11:58:35
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE PurchaseCreate(IN paramUniqId VARCHAR(255), IN paramTermekKod VARCHAR(255), IN paramIdopont DATETIME, IN paramfizetesiMod VARCHAR(255))
BEGIN
