...
-- Script date 2020. 03. 18. 16:23:26
...
--
-- Create procedure `ShifterCreate`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE ShifterCreate(OUT paramId INT, IN paramValto VARCHAR(255))
BEGIN
INSERT INTO valtok (valtok.tipus)
  VALUES (paramValto);
SELECT
  LAST_INSERT_ID() AS paramId;
END
