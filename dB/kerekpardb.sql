...
-- Script date 2020. 01. 28. 11:00:18
...
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE BicycleCreate(OUT paramId INT, IN paramCikkszam CHAR(16), IN paramMarkaId INT, IN paramVazmeretId INT, IN paramFelniAtmeroId INT, IN paramValtoTipus INT, IN paramTipusId INT, IN paramAr INT)
BEGIN
INSERT INTO kerekpar (cikkszam, markaId, vazmeretId, felniAtmeroId, valtoTipus, tipusId, ar)
  VALUES (paramCikkszam, paramMarkaId, paramVazmeretId, paramFelniAtmeroId, paramValtoTipus, paramTipusId, paramAr);
SELECT
  LAST_INSERT_ID() AS paramId;
END
$$
...
(9, '08560d86-69e9-4133-9497-9ad9d04d359e', 'teszt@gmail.com', 'cGFzc3dvcmQ=', 'ROLE_CLIENT');
